...
import { PLAYERS, MANAGERS, DEMO_ORDER, type Player, type Manager } from "./data";
...
const REVEAL_FRAMES = 210;
const MGMT_TITLE_FRAMES = 90;

const PLAYERS_END = INTRO_FRAMES + DEMO_ORDER.length * REVEAL_FRAMES;
const MGMT_START = PLAYERS_END;
const MGMT_REVEALS_START = MGMT_START + MGMT_TITLE_FRAMES;
const CLOSING_START = MGMT_REVEALS_START + REVEAL_FRAMES;
const CLOSING_FRAMES = 150;
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Booking CTA with inverted logo behind */}
          <div
            style={{
              position: "relative",
              display: "flex",
          ...
          >
            {/* Inverted logo watermark behind the CTA */}
            <Img
        ...
        >
          <span style={{ fontSize: 28, fontWeight: 700, color: "#D42027" }}>
            {player.subjectAr}
          </span>
          <span
            style={{
...
export const LineupVideo: React.FC = () => {
  ...
  const isManagement = frame >= MGMT_START;
  ...
  return (
    ...
    >
      ...
      <Sequence
        key="mgmt-title"
        from={MGMT_START}
        durationInFrames={MGMT_TITLE_FRAMES}
      >
        <ManagementTitle />
      </Sequence>
      {/* ===== DUAL MANAGER REVEAL ===== */}
